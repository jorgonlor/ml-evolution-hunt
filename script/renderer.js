...
class Renderer {
    ...
    defineDrawingFunctions() {
        ...
        Creature.prototype.draw = function (ctx, scale, point2canvas) {
            ...
            var hex = toHex(Math.floor(255 * this.energy / this.maxEnergy));
            ...
            if(this.alive) {
                ...
                let p_far = vadd(this.body.p, vmult(this.body.rot, 2 * this.radius));
                self.drawLine(p_near, p_far, 'black', 1);
            }
        }

        Food.prototype.draw = function (ctx, scale, point2canvas) {
